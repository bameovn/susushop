...
class MainPage extends React.Component {
	...
	render() {
		...
		<React.Fragment>
		  <Carousel autoplay>
		    <div><img src="./slider1.png" width="100%" alt="slider1"/></div>
			<div><img src="./slider2.png" width="100%" alt="slider2"/></div>
			<div><img src="./slider1.png" width="100%" alt="slider3"/></div>
		  </Carousel>
		  <Product title={'Bán chạy nhất'} 
